...
def _cached_answer(question: str, context_chunks: tuple[str, ...], language: str) -> str:
    ...
    system = (
        ...
        "certification platform. Answer ONLY using the CONTEXT provided. If the context doesn't "
        "cover the question, say you don't have that information and suggest contacting support "
        "or browsing the courses page - never invent course names, prices, or policies. "
